...
const projects: Project[] = [
  {
    ...
    description: "AI-powered GitHub profile analyzer that processes repositories in parallel with real-time streaming to deliver code analysis and personalized feedback.",
  ...
  {
    title: "Time Tracker",
    description: "Comprehensive employee time tracking platform with admin dashboard, web app, and Electron desktop client featuring JWT auth and real-time sync.",
  ...
  {
    title: "AI Chat PDF",
    description: "PDF RAG application that processes documents into searchable vector embeddings, enabling fast and contextually relevant query responses.",
  ...
  {
    title: "Sa Re Ga Ma",
    description: "Comprehensive Discord music bot with full playback control and an automated recommendation system powered by YouTube's algorithm.",
